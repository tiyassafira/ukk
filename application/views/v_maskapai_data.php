            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $m->seat_qty ?></td>
                  <td><a style="cursor: pointer;" title="" onclick="href='<?php echo base_url(('admin/hapus_maskapai/'.$m->id)); ?>'"><button type="button" class="btn btn-danger glyphicon glyphicon-trash"></button></a>
                    <a style="cursor: pointer;" title="" onclick="href='<?php echo base_url(('admin/edit_maskapai/'.$m->id)); ?>'"><button type="button" class="btn btn-warning glyphicon glyphicon-edit"></button></a>
                  </td>
                </tr>
                <?php } ?>
              </table>
